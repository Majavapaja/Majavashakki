  ...
  public render() {
    ...
    const form = (
      <React.Fragment>
        ...
        />
        <Button id="signupButton" variant="contained" color="primary" type="submit" className={classes.button}>
    ...
    return (
      <form className={classes.root} onSubmit={this.handleSubmit}>
        <Paper className={classes.formContainer} onKeyPress={this.handleEnterKey}>
