...
describe("Pawn", () => {
    describe("Basic movement", () => {
        it("should allow white pawn to move forward [a2, a3]", done => {
            ...
            promise.should.eventually.to.have.same.members(["move"]).notify(done);
        });
        ...
        it("should allow white pawn to move forward twice [a2, a3], [a3, a4]", done => {
            ...
            promise.should.eventually.to.have.same.members(["move", "move"]).notify(done);
        });
        ...
        it("should not allow white pawn to move diagoanlly [a2 b3]", done => {
            ...
            promise.should.eventually.to.have.same.members(["error"]).notify(done);
        });
        ...
        it("should not allow white pawn to move forward and then backward [a2 a3], [a3 a2]", done => {
            ...
            promise.should.eventually.to.have.same.members(["move", "error"]).notify(done);
        });
    ...
    describe("Capturing", () => {
        it("should allow white pawn to capture diagonally [d4 e5]", done => {
            ...
            promise.should.eventually.to.have.same.members(["capture"]).notify(done);
        });
